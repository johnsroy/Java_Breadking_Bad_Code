...
public class FootballPlayer40YardDashInfo {
	...
	public void printPlayersWith40Avg(){
		...
		double avg40YdDash = getAvgDashTime(); //not required
	...
	public static void main(String[] args){
		...
		FootballPlayer2 clarkKent = new FootballPlayer2("Clark Kent", cKent40YdDashTimes);
		fb40Dash.addFootballPlayer(clarkKent);
		
		// Add Bruce Wayne for example
		
		double bWayne40YdDashTimes[] = {4.42, 4.43, 4.49};
		FootballPlayer2 bruceWayne = new FootballPlayer2("Bruce Wayne", bWayne40YdDashTimes);
...
/* Replacing a temp with a Query or method

double avgDashTime = totalDashTimes / totalDashes; //a temp
...
if(avgDashTime() > 4.41) {					//using a method and removing the temp
	System.out.println("Average Time");
}
