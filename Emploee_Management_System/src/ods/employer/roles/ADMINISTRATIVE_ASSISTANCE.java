...
public class ADMINISTRATIVE_ASSISTANCE extends JFrame
{
	...
	public ADMINISTRATIVE_ASSISTANCE()
	{
		super();
		userinterface();
	...
	public void userinterface()
	{
		...
		this.setTitle("ADMINISTRATIVE ASSISTANCE PAGE");
	...
	private void finder(String employee)
	{
		...
		try
		{
			...
			String query = "select first_name from student_employee where UID = "+Integer.parseInt(employee)+" AND Position_id IN (select position_id from position_jobs where position_id = 'AA')";
			...
			if(employeename != "")
			{
				jTextArea1.append("EMPLOYEE_NAME: "+employeename+"\n");
