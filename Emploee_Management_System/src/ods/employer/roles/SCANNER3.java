...
public class SCANNER3 extends JFrame
{
	...
	private void finder(String employee)
	{
		...
		try
		{
			...
			String query = "select first_name from student_employee where UID = "+Integer.parseInt(employee)+" AND Position_id IN (select position_id from position_jobs where position_id = 'S3')";
